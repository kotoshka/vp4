                ...
                @foreach($products as $product)
                    <div class="products-columns__item">
                        <div class="products-columns__item__title-product">
                            <a href="/product/?id={{$product->id}}" class="products-columns__item__title-product__link">{{$product->name}}</a>
                        </div>
                        <div class="products-columns__item__thumbnail">
                            <a href="/product/?id={{$product->id}}" class="products-columns__item__thumbnail__link">
                        ...
                        <div class="products-columns__item__description">
                            ...
                            <a href="{{route('cart.index', ['id' => $product->id])}}" class="btn btn-blue buy-btn">Купить</a>
                        </div>
                    </div>
                @endforeach
            </div>
